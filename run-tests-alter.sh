...
# Zookeeper servers
ZOOKEEPER=( "nymfe26.fi.muni.cz" "nymfe27.fi.muni.cz" "nymfe28.fi.muni.cz" )
# Zookeeper servers with ports
ZOOKEEPER_PORT=( "nymfe26.fi.muni.cz:2181" "nymfe27.fi.muni.cz:2181" "nymfe28.fi.muni.cz:2181" )
...
function set_one_kafka {
  # Kafka servers
  KAFKA=( "nymfe50.fi.muni.cz" )
  # Kafka servers with ports
  KAFKA_PORT=( "nymfe50.fi.muni.cz:9092" )
...
function set_three_kafka {
  # Kafka servers
  KAFKA=( "nymfe50.fi.muni.cz" "nymfe51.fi.muni.cz" "nymfe52.fi.muni.cz" )
  # Kafka servers with ports
  KAFKA_PORT=( "nymfe50.fi.muni.cz:9092" "nymfe51.fi.muni.cz:9092" "nymfe52.fi.muni.cz:9092" )
  KAFKA_LEN=${#KAFKA[@]} # length
  KAFKA_STR=$(IFS=,; echo "${KAFKA[*]}") # comma-separated servers
  KAFKA_PORT_STR=$(IFS=,; echo "${KAFKA_PORT[*]}") # comma-separated servers with ports
  eval_servers
...
function set_five_kafka {
  # Kafka servers
  KAFKA=( "nymfe50.fi.muni.cz" "nymfe51.fi.muni.cz" "nymfe52.fi.muni.cz" "nymfe53.fi.muni.cz" "nymfe54.fi.muni.cz" )
  # Kafka servers with ports
  KAFKA_PORT=( "nymfe50.fi.muni.cz:9092" "nymfe51.fi.muni.cz:9092" "nymfe52.fi.muni.cz:9092" "nymfe53.fi.muni.cz:9092" "nymfe54.fi.muni.cz:9092" )
  KAFKA_LEN=${#KAFKA[@]} # length
  KAFKA_STR=$(IFS=,; echo "${KAFKA[*]}") # comma-separated servers
  KAFKA_PORT_STR=$(IFS=,; echo "${KAFKA_PORT[*]}") # comma-separated servers with ports
  eval_servers
...
function set_nine_kafka {
  # Kafka servers
  KAFKA=( "nymfe50.fi.muni.cz" "nymfe51.fi.muni.cz" "nymfe52.fi.muni.cz" "nymfe53.fi.muni.cz" "nymfe54.fi.muni.cz" "nymfe62.fi.muni.cz" "nymfe64.fi.muni.cz" "nymfe70.fi.muni.cz" "nymfe71.fi.muni.cz" )
  # Kafka servers with ports
  KAFKA_PORT=( "nymfe50.fi.muni.cz:9092" "nymfe51.fi.muni.cz:9092" "nymfe52.fi.muni.cz:9092" "nymfe53.fi.muni.cz:9092" "nymfe54.fi.muni.cz:9092" "nymfe62.fi.muni.cz:9092" "nymfe64.fi.muni.cz:9092" "nymfe70.fi.muni.cz:9092" "nymfe71.fi.muni.cz:9092" )
  KAFKA_LEN=${#KAFKA[@]} # length
  KAFKA_STR=$(IFS=,; echo "${KAFKA[*]}") # comma-separated servers
  KAFKA_PORT_STR=$(IFS=,; echo "${KAFKA_PORT[*]}") # comma-separated servers with ports
  eval_servers
