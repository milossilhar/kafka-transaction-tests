data <- read.csv("producer_plot_mbs.csv")
...
matplot(data, 
        main="Rýchlosť posielania správ do rôznych tém",
        sub="",
        xlab="Rozdelenie do tém", ylab="Rýchlosť posielania producenta [MB/s]",
        xlim=c(1, 6), ylim=c(ymin, ymax),
        type="o", pch=pch_all, lty = 1, lwd = 1.3,
        col=colors,
        xaxt="n")
axis(1,at=c(1,2,3,4,5,6),labels=c("1-0-0 [1]", "2-0-1 [3]", "5-1-2 [8]", "10-2-4 [16]", "50-10-20 [80]"))
