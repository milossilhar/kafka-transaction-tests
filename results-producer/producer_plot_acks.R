...
text(rep(c(1,2,3,4,5), 3), data.text, data.text, pos=3, col = colors.text, cex=0.9)
legend("left", inset=.02, title="Nastavenie producenta", c("ACKS=all","ACKS=1","Tranzakcie"), col=colors, horiz=FALSE, cex=0.8, lty = 1, lwd = 1.3)
