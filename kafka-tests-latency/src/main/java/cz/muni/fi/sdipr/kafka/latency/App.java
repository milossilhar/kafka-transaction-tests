...
/**
 * Application for testing Kafka producer and latency between producer and consumer.
 * Available options:
 * -p | --producer-props
 *      Path to producer props file
 * -c | --consumer-props
...
public class App {
    ...
    /**
     * Creates options as described in class javadoc.
     * @return new Options object with created
     */
